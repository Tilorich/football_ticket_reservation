    ...
    <div class="row">
      <div class="column" id="sidebar">
        <div class="ui secondary vertical fluid menu">
          <a class="active item" href="bookings.php">Reservations</a><a class="item" href="transactions.php">Transactions</a>
      ...
      <div class="column" id="content" style="display:none">
        <div class="ui grid">
          <div class="row">
            <h1 class="ui huge header">Seat Reservations</h1>
          </div>
          <div class="ui horizontal divider"> Reservation Details</div>
          <?php
          //rejection
          ...
          ?>
          <div class="row">
            <table class="ui line striped selectable center aligned  table">
              <thead>
                <tr>
                  <th>#Order Ref</th>
                  <th>Customer Name</th>
