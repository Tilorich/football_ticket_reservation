...
<html>
      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            <a class="item" href="bookings.php">Rerservations</a><a class="item " href="transactions.php">Transactions</a>
  ...
  <div class="ui horizontal divider">About me</div>
		...
		<p>Contact the developer@richard.mba.235047@unn.edu.ng</p>
		</div>		
        </div>
			</div>	
		</div>
