...
<head>
  ...
  <title>Welcome to Football Inc</title>
    ...
    <div class="ui text container">
      <div class="ui attached message">
        ...
        if ((isset($_POST['username'])) && (isset($_POST['password']))) {
          ...
          if (($username == "admin") && ($password == "america0442")) {
      ...
      <form class="ui form attached fluid loading segment" method="POST">
        ...
        <input type="submit" name="login" class="ui blue submit button" tabindex=3 value="Login!"> <a href="../index.php" class="ui red submit button" tabindex=3 >Back!</a>
        </div>
      </form>

      <div class="ui bottom attached warning message">
        <i class="icon help"></i> Forgotten password? Just use Username as<a href="#0"> admin</a> and password as <a href="#">america0442</a> to access.
      </div>
