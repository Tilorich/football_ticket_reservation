    ...
    <div class="row">
      <div class="column" id="sidebar">
        <div class="ui secondary vertical fluid menu">
          <a class="item" href="bookings.php">Reservations</a><a class="item active" href="transactions.php">Transactions</a>
      ...
      <div class="column" id="content" style="display:none">
        <div class="ui grid">
          <div class="row">
            <h1 class="ui huge header">Payments Received</h1>
          </div>
          <div class="ui horizontal divider"> Payment Details</div>
          <div class="row">
