...
<title>Football Ticket Reservation System</title>
...
<body>
    <div class="ui inverted huge borderless fixed fluid menu">
      <a class="header item">AKANU IBIAM FOOTBALL TICKET RESERVATION SYSTEM</a>
    </div><br>
...
<div class="ui unstackable tiny steps">
  <div class="step" onclick="booking()">
    ...
    <div class="content">
      <div class="title">Stadium Details</div>
      <div class="description">Set stadium information</div>
    </div>
  </div>
...
<form class="ui form attached fluid loading segment" onsubmit="return contact(this)">
 ...
 <div class="field">
    <select required id="destination">
      <option value="" selected disabled>--Select Stadium--</option>
      <option>Akanu Ibiam Stadium</option>
    </select>
  </div>   
  </div>
<div class="field">  
 ...
 <div class="field">
    <select name="gender" required id="travelclass">
      <option value="" selected disabled>--Seat Row--</option>
      <option>First Row</option>
      <option>Second Row</option>
	   <option>Third Row</option>
      <option>Fourth Row</option>
      <option>Fifth Row</option>
      <option>Six Row</option>
      <option>Seventh Row</option>    </select>
  </div>   
  </div>
...
<div class="field"> 
    <label>Date of Match</label>
       <select required id="traveldate">
      <option value="" selected disabled>Choose A Date</option>
      <option>21-07-2021 4pm
              Pharmacy vs Computer Science</option>
      <option>21-07-2021 12pm
              Mathematics vs Geology</option>   
      <option>23-07-2021 2pm
              Medicine vs Engineering</option>
    </select>
...
<label>Bank Payment</label>  
    <select name="gender" required id="paymentmethod">
      <option value="" selected disabled>Select Preferred Bank</option>
      <option value="ECOBANK">ECOBANK</option>
      <option value="FIRST_BANK">FIRST BANK</option>
    <option value="ZENITH_BANK">ZENITH BANK</option>
    <option value="GTB_BANK">GTB BANK</option>
    </select>
  </div> 
<div class="field"> 
<label>Account Number</label> 
<div class="ui icon input">
  <input placeholder="Account Number" type="text" required id="acct" minlength="10" maxlength="10">
  <!--<i class="payment icon"></i>-->
</div>
</div>

  <div class="field"> 
<label>Confirm Amount(N)</label>

<div class="ui icon input">
  <input value="1,500.00" type="text" id="amount" readonly>
</div></div>
 <div style="text-align:center">
...
<b>Before proceeding, re-check the following details you provied</b>
<br>
