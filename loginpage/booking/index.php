...
<head>
  ...
  <title>Generating Ticket Ref No </title>
...
<body>
  <div class="ui inverted huge borderless fixed fluid menu">
    <a class="header item" href="index.php">AKANU IBIAM FOOTBALL TICKET RESERVATION SYSTEM</a>
  </div><br>
  <div class="ui text container" style="margin-top:90px">
    <div id="err001" class="ui icon small attached message">
      <i class="notched circle loading icon" id="loada"></i>
      <div class="content">
        <div class="header" id="heada">Configuring ticket engine....</div>
        <p id="subheada">Requesting for Order Ref.. just a sec.</p>
        <div id="proceed"></div>
      </div>
    </div>
  ...
  <script>
    setTimeout(function() {
      ...
      document.getElementById("heada").innerHTML = "System Set!";
      document.getElementById("subheada").innerHTML = "Order reference created. Click on Proceed to start reservation!";
