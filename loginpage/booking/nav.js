...
//Clearing all data 
$("#dynamic").html("<div class='ui text container'><div id='err001' class='ui success icon message'><i class='notched circle loading icon'></i><div class='content'><div class='header'>Please wait....</div><p>We are setting up your ticket. </p></div></div>");    
